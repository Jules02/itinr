...
// Returns the private 'App\Repository\PathRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PathRepository.php';

return $this->privates['App\Repository\PathRepository'] = new \App\Repository\PathRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
