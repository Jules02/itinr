...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\PathType' => function () {
    return ($this->privates['App\Form\PathType'] ?? $this->privates['App\Form\PathType'] = new \App\Form\PathType());
